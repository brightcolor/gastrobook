...
@php
    ...
    $items = [
        ...
        ...($isSalon ? [
            ['route' => 'admin.staff.calendar', 'label' => 'Terminplan',  'perm' => 'reservations.view', 'icon' => $si('M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75M3 11.25h18M8.25 15h.008v.008H8.25V15zm3.75 0h.008v.008H12V15zm3.75 0h.008v.008h-.008V15z')],
        ...
        ['route' => 'admin.templates.index',    'label' => 'E-Mail-Vorlagen', 'perm' => 'templates.manage',  'icon' => $si('M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75')],
        ...
        ['route' => 'admin.marketing.index',    'label' => 'Marketing',       'perm' => 'marketing.manage',  'icon' => $si('M10.34 15.84c-.688-.06-1.386-.09-2.09-.09H7.5a4.5 4.5 0 110-9h.75c.704 0 1.402-.03 2.09-.09m0 9.18c.253 1.084.575 2.14.959 3.162.535 1.425 2.313 1.865 3.55.884l.088-.07m-4.597-3.976A48.4 48.4 0 0112 15.75c2.305 0 4.547.26 6.7.75m-8.36-.66V6.66m8.36 9.84a24.3 24.3 0 000-9.84m0 9.84c.39.12.78.25 1.17.4 1.07.41 2.1-.4 2.1-1.55V7.83c0-1.15-1.03-1.96-2.1-1.55-.39.15-.78.28-1.17.4')],
        ['route' => 'admin.webhooks.index',     'label' => 'Webhooks',        'perm' => 'webhooks.manage',   'icon' =>$si('M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m13.35-.622l1.757-1.757a4.5 4.5 0 00-6.364-6.364l-4.5 4.5a4.5 4.5 0 001.242 7.244')],
