...
@section('title', 'Ihr Feedback')
@section('content')
<div class="rounded-2xl bg-white p-6 shadow-sm">
    <h1 class="text-center text-2xl font-bold">Wie war Ihr Besuch?</h1>
    ...
    <form method="POST" action="{{ route('feedback.store', ['token' => $feedbackRequest->token]) }}" class="mt-6 space-y-5">
        ...
        <div>
            <label for="comment" class="mb-1 block text-sm font-semibold">Möchten Sie uns etwas mitteilen? (optional)</label>
